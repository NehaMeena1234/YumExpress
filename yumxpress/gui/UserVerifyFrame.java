...
public class UserVerifyFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnQuit, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 370, 120, 39));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 320, 310));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 380, 450));

        jPanel3.setBackground(new java.awt.Color(51, 153, 255));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 50, 470, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/user selection.png"))); // NOI18N
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 370, 350));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -6, 400, 460));
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        if (jrSeller.isSelected()) {
            ...
            showFrame = new SellerLoginFrame1();
